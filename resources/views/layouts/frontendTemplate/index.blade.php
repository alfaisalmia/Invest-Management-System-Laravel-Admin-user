...
@section('content')
    ...
    <!-- navi wrapper End -->    <!-- slider wrapper start -->
    <div class="slider-area slider_index2_wrapper float_left">
        <div class="index2_sliderbg">
            <img src="{{ asset('frontend/assets/images/sliderbg.png')}}" alt="img" class="img-responsive">
        </div>
...
For <span>Future</span></h3>
                                        <div data-animation="animated bounceInUp" class="line_shape"></div>
                                        ...
                                        <div class="slider_btn index2_sliderbtn float_left">
                                            <ul>
...
For <span>Future</span></h3>
    ...
    <div class="about_us_wrapper index2_about_us_wrapper float_left">
        <div class="container">
            <div class="row">

                <div class="col-xl-6 col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="index2_abt_img_wrapper">

                        <img src="{{ asset('frontend/assets/images/abt_3.png')}}" alt="About" class="img-responsive">

                        <div class="sw_disc_img_btm">
                            <img src="{{ asset('frontend/assets/images/abt_2.png')}}" alt="About" class="img-responsive">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="about_content_wrapper">
                        <div class="sv_heading_wraper index2_heading">
                            <h4>who we are</h4>
                            <h3>Welcome to FxIntense</h3>
    ...
    <div class="investment_plans index2_investment_plans float_left">
    ...
    <div class="calculator_wrapper index2_calculator_wrapper float_left">
        <div class="container">
            <div class="row">

                <div class="col-md-12 col-lg-12 col-sm-12 col-12">
                    <div class="sv_heading_wraper heading_wrapper_dark dark_heading index2_heading index2_heading_center">
                        <h4> plans calculator </h4>
                        <h3> How Much Can You Save With Plans? </h3>
                        <div class="line_shape"></div>
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 calc">
                    <div class="mutualfunds-calculator index2_mutualfund">
                        <div class="calculator calculator_index2">
                            <div class="graph-area">
                                <span class="mf-yAxis">Investment Value</span>
                                <svg width="100%" height="350" id="graph" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 900 355" class="mf-chart">
            ...
            475,20" fill="none" id="path2" stroke="#05a4cd" stroke-width="5px" stroke-linecap="round" class="anim-path" style="transition: stroke-dashoffset 2s ease-in-out; stroke-dasharray: 572.872, 572.872; stroke-dashoffset: 0px; display: inline;"></path>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12 calc">

                    <div class="calculator_portion index2_calculation_portion float_left">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="about_btn calc_btn index2_calc_btn float_left" onclick="CalCommission(); return false;">
                                    <ul>
                                        <li>
...
Commissions</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 col-sm-6 col-12">
                    <div class="investment_box_wrapper service_box feature_box index2_service_box float_left">
                        <div class="investment_icon_circle">
                            <i class="flaticon-medal"></i>
                        </div>
                        <div class="investment_border_wrapper"></div>
                        <div class="investment_content_wrapper">
                            ...
                            <span class="investment_index_icon"><a href="#"><i class="flaticon-arrow-pointing-to-right"></i></a></span>
                        </div>
    ...
    <div class="works_wrapper float_left">
        <div class="work_banner_wrapper">
            <img src="{{ asset('frontend/assets/images/video_bg.jpg')}}" alt="img">
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="saying_slider">
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                <div class="saying_content_wrapper float_left">
                                    <div class="saying_img">
                                        <img src="{{ asset('frontend/assets/images/cnt1.png')}}" alt="img">
                                    </div>
                            ...
                            <div class="item">
                                <div class="saying_content_wrapper float_left">
                                    <div class="saying_img">
                                        <img src="{{ asset('frontend/assets/images/cnt2.png')}}" alt="img">
                                    </div>
                                    <div class="saying_img_name">
                            ...
                            <div class="item">
                                <div class="saying_content_wrapper float_left">
                                    <div class="saying_img">
                                        <img src="{{ asset('frontend/assets/images/cnt.png')}}" alt="img">
                                    </div>
                                    <div class="saying_img_name">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="sv_heading_wraper half_section_headign index2_heading">
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 sw_spectrm_padding">
                    <div class="investors_slider_wrapper index2_investors_slider_Wrapper">
                        <div class="owl-carousel owl-theme">
                            <div class="item">

                                <div class="inves_slider_cntn index2_inves_slider_cntnt float_left">
                                    <div class="investment_box_wrapper index_investment float_left">
                                        ...
                                        <div class="inves_main_border float_left">
                                            <div class="inves_img_wrapper">
                                                <img src="{{ asset('frontend/assets/images/inves1.png')}}" class="img-responsive" alt="img" />
                                            </div>
                                            ...
                                            <div class="investment_content_wrapper inves_heading_txt">
                                                ...
                                                <div class="line_shape investment_line_shape"></div>
                                                <p>$22500.00 USD</p>
                                                <ul class="investment_slider_icon">
                            ...
                            <div class="item">
                                ...
                                <div class="inves_slider_cntn index2_inves_slider_cntnt float_left">
                                    <div class="investment_box_wrapper index_investment float_left">
                                        ...
                                        <div class="inves_main_border float_left">
                                            <div class="inves_img_wrapper">
                                                <img src="{{ asset('frontend/assets/images/inves2.png')}}" class="img-responsive" alt="img" />
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="inves_slider_cntn index2_inves_slider_cntnt float_left">
                                    <div class="investment_box_wrapper index_investment float_left">
                                        ...
                                        <div class="inves_main_border float_left">
                                            <div class="inves_img_wrapper">
                                                <img src="{{ asset('frontend/assets/images/inves3.png')}}" class="img-responsive" alt="img" />
                                            </div>
                            ...
                            <div class="item">
                                ...
                                <div class="inves_slider_cntn index2_inves_slider_cntnt float_left">
                                    <div class="investment_box_wrapper index_investment float_left">
                                        ...
                                        <div class="inves_main_border float_left">
                                            <div class="inves_img_wrapper">
                                                <img src="{{ asset('frontend/assets/images/inves4.png')}}" class="img-responsive" alt="img" />
                                            </div>
    ...
    <div class="global_community_wrapper newsletter_wrapper index2_newsletter float_left">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog_box_wrapper index2_blog_wrapepr float_left">
                        <div class="blog_img_wrapper">
                            <img src="{{ asset('frontend/assets/images/blog_img1.jpg')}}" alt="blog_img">
                            <div class="blog_date_wrapper index2_blog_date">
                                <p>15
                                    <br> <span>jun</span></p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog_box_wrapper index2_blog_wrapepr float_left">
                        <div class="blog_img_wrapper">
                            <img src="{{ asset('frontend/assets/images/blog_img2.jpg')}}" alt="blog_img">
                            <div class="blog_date_wrapper index2_blog_date">
                                <p>15
                                    <br> <span>jun</span></p>
                            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="blog_box_wrapper index2_blog_wrapepr float_left">
                        <div class="blog_img_wrapper">
                            <img src="{{ asset('frontend/assets/images/blog_img3.jpg')}}" alt="blog_img">
                            <div class="blog_date_wrapper index2_blog_date">
                                <p>15
                                    <br> <span>jun</span></p>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
                                <div class="card-body">
                                    <div class="card_img">
                                        <img src="{{ asset('frontend/assets/images/ac1.jpg')}}" alt="img">
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion" style="">
                                <div class="card-body">
                                    <div class="card_img">
                                        <img src="{{ asset('frontend/assets/images/ac2.jpg')}}" alt="img">
                                    </div>
                                    <div class="card_cntnt">
                                        <p>Morbi accumsan ipsum velit. Nam nec aks tel lus a odio tincidunt auctor. Proi gravida nibh vel velit auctor.</p>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                <div class="card-body">
                                    <div class="card_img">
                                        <img src="{{ asset('frontend/assets/images/ac3.jpg') }}" alt="img">
                                    </div>
                                    <div class="card_cntnt">
                                        <p>Morbi accumsan ipsum velit. Nam nec aks tel lus a odio tincidunt auctor. Proi gravida nibh vel velit auctor.</p>
                                    </div>
