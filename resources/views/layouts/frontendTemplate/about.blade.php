...
<!-- navi wrapper End -->    <!-- inner header wrapper start -->
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                            <div class="sv_abt_img_wrapper float_left">
                                <img src="{{ asset('frontend/assets/images/abt_img.jpg') }}" alt="img" class="img-responsive">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-12 col-sm-12">
...
Your Money !</h2>
            ...
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                ...
                <div class="sv_abt_img_wrapper float_left">
                    <img src="{{ asset('frontend/assets/images/abt_1.png') }}" alt="img" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="testimonial_slide_main_wrapper dark_top_testimonial">
                                ...
                                <div class="ts_img_social_wrapper">
                                    <div class="ts_client_img_wrapper">
                                        <img src="{{ asset('frontend/assets/images/ts1.png') }}" class="img-responsive" alt="client_img" />
                                    </div>
                        ...
                        <div class="item">
                            <div class="testimonial_slide_main_wrapper">
                                ...
                                <div class="ts_img_social_wrapper p2">
                                    ...
                                    <div class="ts_client_img_wrapper">
                                        <img src="{{ asset('frontend/assets/images/ts2.png') }}" class="img-responsive" alt="client_img" />
                                    </div>
