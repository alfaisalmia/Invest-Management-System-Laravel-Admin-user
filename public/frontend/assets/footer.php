        ...
        <div class="col-lg-4 col-md-6 col-12 col-sm-12">
            <div class="wrapper_second_about">
                <div class="wrapper_first_image">
                    <a href="index.php"><img src="images/logo.png" class="img-responsive" alt="logo" style="width: 205px; height:55px;"/></a>
                </div>
        ...
        <div class="col-lg-4 col-md-6 col-12 col-sm-12">
            <div class="wrapper_second_useful wrapper_second_useful_2">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="flaticon-mail"></i>info@fxintense.com</a>
                    </li>
...
Islamabad
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            <div class="copyright_wrapper float_left">
                <div class="copyright">
                    <p>Copyright <i class="far fa-copyright"></i> 2022 <a href="index.html"> Fxintense</a>. all right reserved.</p>
                </div>
